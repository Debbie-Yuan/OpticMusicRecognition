...
from PyQt5.QtWidgets import QGraphicsDropShadowEffect, QPushButton, QSizePolicy, QSizeGrip

import files_rc  # noqa
from Apps.base.ui_styles import Style
    ...
    def uiDefinitions(self):
        def dobleClickMaximizeRestore(event):
            ...
            if event.type() == QtCore.QEvent.MouseButtonDblClick:
                QtCore.QTimer.singleShot(250, lambda: UIFunctionsMixin.maximize_restore(self))
        ...
        # ==> MAXIMIZE/RESTORE
        self.ui.btn_maximize_restore.clicked.connect(lambda: UIFunctionsMixin.maximize_restore(self))

        # SHOW ==> CLOSE APPLICATION
        self.ui.btn_close.clicked.connect(self._soft_close)
